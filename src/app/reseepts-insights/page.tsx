  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 pb-20">
        {isLoading ? (
          // Loader Skeleton
          <div className="bg-gradient-to-b from-teal-800 to-teal-600 border border-teal-500/40 rounded-xl p-6 mb-6 backdrop-blur-sm animate-pulse">
            <div className="flex items-start gap-3 mb-4">
              <div className="w-5 h-5 bg-teal-400 rounded-full flex-shrink-0 mt-1"></div>
              <div className="flex-1">
                <div className="h-4 bg-teal-300 rounded w-24 mb-2"></div>
                <div className="h-3 bg-gray-400 rounded w-16"></div>
              </div>
            </div>
            <div className="h-4 bg-white rounded w-full mb-4"></div>
            <div className="space-y-4 mt-6">
              {Array.from({ length: 3 }).map((_, index) => (
                <div
                  ...
                  key={index}
                >
                  <div className="h-4 bg-white rounded w-6"></div>
          ...
          <div className="bg-gradient-to-b from-teal-800 to-teal-600 border border-teal-500/40 rounded-xl p-6 mb-6 backdrop-blur-sm">
            ...
            <div className="mt-6 p-3 bg-slate-800/50 rounded-lg border border-teal-900">
              <p className="text-gray-400 text-xs">
                * The information in this report could be inaccurate. Please
